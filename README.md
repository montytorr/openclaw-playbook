...
**Current examples reflect a Codex-first production setup** with `gpt-5.4` as the primary model, `gpt-5.3-codex` as the stable fallback, and `spark` treated as a conditional fast lane rather than a blind default fallback.
